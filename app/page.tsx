    ...
    <AnimatePresence>
      {loading ? (
        ...
        >
          ...
          >
            <motion.div
              className="sticky top-0 z-20 -mx-2 mb-10 flex items-center gap-3 rounded-xl bg-slate-950/70 px-4 py-3 backdrop-blur-md supports-[backdrop-filter]:bg-slate-950/55"
